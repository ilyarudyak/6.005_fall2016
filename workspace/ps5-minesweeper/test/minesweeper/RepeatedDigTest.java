...
public class RepeatedDigTest {

    @Test(timeout=10000)
    public void testRepeatDig() throws IOException, InterruptedException {
        ...
        try {
            ...
            for(int i=0; i<expected.length; i++) {
                moo = in.readLine();
                assertEquals("(whitespace removed)", 
                        TestUtil.nosp(expected[i]), TestUtil.nosp(moo));
            }
